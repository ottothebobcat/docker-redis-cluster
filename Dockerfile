...
RUN sed -i 's,/redis/src/redis-server /redis-conf/$port/redis.conf,/redis/src/redis-server /redis-conf/$port/redis.conf --protected-mode no,' /generate-supervisor-conf.sh
